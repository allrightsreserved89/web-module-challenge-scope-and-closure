...
/*Task 1: counterMaker()
  ...
  counter 1. because it returns the counterMaker function returns the function counter
  3. In what scenario would the counter1 code be preferable? In what scenario would 
     counter2 be better?  
     its good to use counter 1s method of closure when trying to avoid utilizing data within the global scope.
*/
...
function getInningScore(inning) {
  let score = {Home: inning(), Away: inning()};
  return score;
}
